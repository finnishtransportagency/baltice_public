                ...
                <nav className="flex flex-wrap space-x-4 py-4">
                    <Link href="/">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="40" height="40" rx="20" fill="#49C2F1"/>
                            <path d="M17.3337 30.6667V22.6667H22.667V30.6667H29.3337V20H33.3337L20.0003
                                8L6.66699 20H10.667V30.6667H17.3337Z" fill="white"/>
                        </svg>
                    </Link>
                    <Link href={"/ships"} className="cursor-pointer px-4 py-2 bg-baltice-blue text-white">
                        Ships & Restrictions
                    </Link>
                    <Link href={"/traffic"} className="cursor-pointer px-4 py-2 bg-baltice-blue text-white">
                        Traffic & Ice Situation Map
                    </Link>
                    <Link href={"/weather"} className="cursor-pointer px-4 py-2 bg-baltice-blue text-white">
                        Ice & Weather
                    </Link>
                    <Link href={"/reporting"} className="cursor-pointer px-4 py-2 bg-baltice-blue text-white">
                        Reporting
                    </Link>
                    <Link href={"/about"} className="cursor-pointer px-4 py-2 bg-baltice-blue text-white">
                        About
                    </Link>
                </nav>
            </div>
