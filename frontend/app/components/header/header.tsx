...
export default function Header() {
  return (
    <header className="bg-white text-gray-800 shadow-md py-4 px-6 z-40 relative">
        ...
        <nav className="flex flex-wrap space-x-4 py-4">
          <Link href="/">
            ...
            >
              ...
              <path
                d="M17.3337 30.6667V22.6667H22.667V30.6667H29.3337V20H33.3337L20.0003
                                8L6.66699 20H10.667V30.6667H17.3337Z"
                fill="white"
              />
            </svg>
          </Link>
          <Link
            href={"/ships"}
            className="cursor-pointer px-4 py-2 bg-baltice-blue text-white"
          >
            Ships & Restrictions
          </Link>
          <Link
